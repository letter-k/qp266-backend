...
def username_validator(username):
    ...
    if match is None and 3 <= len(username) <= 20:
        raise ValidationError(
            "Введите правильное имя пользователя. Оно может содержать только латинские буквы, "
            "цифры и знак нижнего подчеркивания и быть длиной от 3 до 20 символов"
        )
